    ...
    internal class T4ServicoLayout : BaseLayout<T4Servico>
    {
        public T4ServicoLayout()
        {
            this
                ...
                .WithMember(x => x.NumeroTelefoneChamado   , c => c.WithLength(10).WithRightPadding(' '))
                ...
                .WithMember(x => x.Grupo                   , c => c.WithLength(3 ).WithRightPadding(' '))
                .WithMember(x => x.DescricaoGrupo          , c => c.WithLength(30).WithRightPadding(' '))
                .WithMember(x => x.Categoria               , c => c.WithLength(3 ).WithRightPadding(' '))
                .WithMember(x => x.DescricaoCategoria      , c => c.WithLength(40).WithRightPadding(' '))
